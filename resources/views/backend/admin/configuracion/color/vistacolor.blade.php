...
@stop
    ...
    @section('js')
        ...
        <script>
            $(function () {
                const ruta = "{{ url('/admin/color/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/color/tabla/index') }}";
        ...
        function nuevo(){
            ...
            axios.post(urlAdmin+'/admin/color/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(urlAdmin+'/admin/color/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(urlAdmin+'/admin/color/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
