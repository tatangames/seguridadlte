...
@stop
    ...
    @section('js')
        ...
        <script>
            $(function () {
                const ruta = "{{ url('/admin/jefefirma/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/jefefirma/tabla/index') }}";
        ...
        function nuevo(){
            ...
            axios.post(urlAdmin+'/admin/jefefirma/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(urlAdmin+'/admin/jefefirma/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(urlAdmin+'/admin/jefefirma/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
